...
final class AppStateIdleTests: XCTestCase {
    ...
    /// Опрос раз в секунду неделями — два с половиной миллиона пробуждений в
    /// месяц ради ответа, который не меняется.
    func testКогдаВсёВыданоРазрешенияОпрашиваютсяРеже() {
