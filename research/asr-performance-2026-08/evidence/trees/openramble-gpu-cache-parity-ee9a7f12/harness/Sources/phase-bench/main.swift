...
private enum PhaseBench {
    static func main() async throws {
        ...
        let useAllGPU = ProcessInfo.processInfo.environment["OPENRAMBLE_TEMP_ALL_GPU"] == "1"
        let primaryComputeUnits: MLComputeUnits = useAllGPU ? .cpuAndGPU : .all
        let configuration = MLModelConfiguration()
        configuration.computeUnits = primaryComputeUnits
        ...
        let models = try await AsrModels.load(
            ...
            encoderComputeUnits: primaryComputeUnits)
        ...
        let report = Report(
            ...
            shippingConfiguration: ShippingConfiguration(
                computeUnits: useAllGPU ? "MLComputeUnits.cpuAndGPU" : "MLComputeUnits.all",
                encoderComputeUnits: useAllGPU ? "MLComputeUnits.cpuAndGPU" : "MLComputeUnits.all",
                encoderPrecision: "int8",
                melChunkContext: false,
                parallelChunkConcurrency: 4,
